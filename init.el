...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (hungry-delete doom-modeline all-the-icons avy company-jedi slime-company slime company sudo-edit magit dashboard async pretty-mode projectile org org-mode which-key seoul256-theme use-package))))
(custom-set-faces
